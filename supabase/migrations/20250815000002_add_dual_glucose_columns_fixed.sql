...
-- Add constraints for reasonable value ranges (but not the NOT NULL constraint yet)
ALTER TABLE public.glucose_readings 
...
-- Now add the constraint to ensure at least one value is provided (after data is populated)
ALTER TABLE public.glucose_readings 
