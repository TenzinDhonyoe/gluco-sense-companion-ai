...
const GlucoseTracker = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pb-20 safe-area-top" style={{ paddingTop: 'max(3rem, env(safe-area-inset-top))' }}>
